...
private let log = Logger(subsystem: "com.mtkg.keykun", category: "update")
...
struct UpdateService {
    static let repoFullName = "m-tkg/keykun"
    static let apiBase = "https://api.github.com"
    private static let userAgent = "Keykun"
    ...
    func downloadReleaseZip(_ release: ReleaseInfo, into directory: URL) async throws -> URL {
        ...
        let destination = directory.appendingPathComponent("Keykun.zip")
